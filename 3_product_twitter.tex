...
ツイートは移動経路の可視化と同様に取得した, 今回は東京都内のツイートをサンプルとした\tabref{event_tweet_count}.
...
今回の研究でTweetの収集するに当たり位置情報付きのツイートを API を使用して一括で収集するWebアプリケーションも作成した.\figref{controller_app}
